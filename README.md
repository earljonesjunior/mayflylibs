...
This branch has just a library.json file for [PlatformIO](http://platformio.org/) to correctly download all of the other libraries.  To install the entire collection on PlatformIO use the command:  pio lib install https://github.com/EnviroDIY/Libraries.git#platformio
